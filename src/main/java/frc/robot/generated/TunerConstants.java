...
public class TunerConstants {
    ...
    private static final MountPoseConfigs pig = new MountPoseConfigs().withMountPoseYaw(0);
    private static final Pigeon2Configuration pigeonConfigs = new Pigeon2Configuration().withMountPose(pig);
    ...
    private static final Distance kWheelRadius = Inches.of(1.9685);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.32080078125);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.17041015625);
     ...
     */
    public static CommandSwerveDrivetrain createDrivetrain(StateMachine stateMachine) {
        return new CommandSwerveDrivetrain(
            stateMachine, DrivetrainConstants, FrontLeft, FrontRight, BackLeft, BackRight
        );
    }
